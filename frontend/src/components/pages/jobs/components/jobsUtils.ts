 ...
 */
export const getPlaceholderImage = (id: string | number) =>
 ...
 */
export const formatSalary = (amount: number | null | undefined, type: string | null | undefined, lang = 'en') => {
  ...
  const suffixValue = type ? suffix[type] || '' : '';
  return `₩${formatted}${suffixValue}`;
};
 ...
 * // Returns: "This is a..."
 */
export const truncateText = (text: string | null | undefined, maxLength = 100) => {
  if (!text) return '';
 ...
 */
export const formatDate = (date: string | Date | null | undefined, locale = 'en-GB') => {
  if (!date) return '';
 ...
 */
export const getRelativeTime = (date: string | Date | null | undefined) => {
  if (!date) return '';
 ...
 */
export const isJobExpired = (deadline: string | Date | null | undefined) => {
 ...
 */
export const getJobTypeLabel = (typeId: string | null | undefined, lang = 'en') => {
 ...
 * @returns {string} The localized label
 */
export const getLocationTypeLabel = (typeId: string | null | undefined, lang = 'en') => {
 ...
 * @returns {string} The localized label
 */
export const getExperienceLevelLabel = (levelId: string | null | undefined, lang = 'en') => {
 ...
 * @returns {string} The localized label
 */
export const getLanguageLevelLabel = (levelId: string | null | undefined, lang = 'en') => {

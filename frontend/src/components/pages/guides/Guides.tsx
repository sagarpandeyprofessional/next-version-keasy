        ...
        return (
          <div key={index} className="mb-6">
            {isHTMLContent(section.body) ? (
              <div 
                className="text-gray-700 leading-relaxed text-lg font-sans prose prose-lg max-w-none prose-p:text-justify"
                dangerouslySetInnerHTML={{ __html: section.body }}
              />
            ) : (
              <p className="text-gray-700 leading-relaxed text-lg font-sans text-justify">
                {section.body}
              </p>
            )}
          </div>

...
import PostMarketplaceItem from './pages/features/marketplace/MarketplaceItemPost'
    ...
    <AuthProvider>
      <Router>
          <Routes>
            ...
            <Route element={<Layout><PrivateRoute><MarketplaceItemEdit /></PrivateRoute></Layout>} path='/marketplace/edit/:id'/> 

...
const FeaturedMarketplaceCard = ({ item }) => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.3 }}
      className="relative h-full rounded-3xl overflow-hidden cursor-pointer group shadow-lg"
    ...
    >
      ...
      {/* ==================== DESKTOP LAYOUT ==================== */}
      <div className="hidden lg:block h-full min-h-[400px] bg-white">
        {/* Background Image */}
        <div className="absolute inset-0 bg-white">
          <img
            ...
            onError={() => setImageError(true)}
            alt={item.title}
            // we can change the y axis of the featured image from here. just need to change the object-center translate-y-[-35px]
            className="w-full h-full object-contain bg-white group-hover:scale-105 transition-transform duration-700 object-center translate-y-[-35px]" 
        ...
        {/* Bottom Content */}
        <div className="absolute bottom-0 left-0 right-0 p-5 z-10 bg-white">

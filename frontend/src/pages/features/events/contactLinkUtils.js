 ...
 */
export function generateContactLink(type, value) {
 ...
 */
export function validateContactInput(type, value) {
  if (!value || !type) {
 ...
 */
export function getContactPlaceholder(type) {
  const placeholders = {
 ...
 */
export function getContactHelperText(type) {
  const helperTexts = {

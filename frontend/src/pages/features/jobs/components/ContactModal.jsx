        ...
        >
          ...
          >
            ...
            <div className="p-6">
              ...
              {/* Click to Apply Button (if external link exists) */}
              {job.contact_apply_link && (
                <div className="mb-4">
                  <a
                    href={job.contact_apply_link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center gap-3 p-4 rounded-xl border-2 border-blue-500 bg-blue-50 hover:bg-blue-100 transition-all duration-200"
                  >
                    <ExternalLink className="w-5 h-5 text-blue-600" />
                    <span className="font-semibold text-blue-700">
                      {lang === 'ko' ? '바로 지원하기' : 'Click to Apply'}
                    </span>
                  </a>
                </div>
              )}

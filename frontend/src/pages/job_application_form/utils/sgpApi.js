...
export const saveApplication = async (formData, contacts, userId = null) => {
  try {
...
export const saveSNSContacts = async (applicationId, contacts) => {
  try {
    const { data, error } = await supabase
...
export const generatePDF = async (applicationId, formData, contacts) => {
  try {
...
export const sendApplicationEmail = async (applicationId, formData, contacts) => {
  try {
...
export const uploadPDF = async (applicationId, pdfBlob, userId) => {
  try {
...
export const openPDFForPrint = (blob) => {
  const url = URL.createObjectURL(blob);
